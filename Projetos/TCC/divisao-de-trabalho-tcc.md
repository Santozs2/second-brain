...
|---|---|---|
| 1️⃣ 🧮 **Motor e calibração** | **você** | Do perfil ao ranking numérico |
| 2️⃣ 🤖 **Camada de IA e experimento** | *a definir* | Do ranking ao texto entregue |
...
1. **Nomes das frentes 2, 3 e 4** e quem é o consolidador
